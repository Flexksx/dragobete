<script>
	...
	import HeartImage from '$lib/components/images/HeartImage.svelte';
	import RoundSquareImage from '$lib/components/images/RoundSquareImage.svelte';
	import CloudImage from '$lib/components/images/CloudImage.svelte';
